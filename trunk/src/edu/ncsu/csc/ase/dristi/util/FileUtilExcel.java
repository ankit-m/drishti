...
public class FileUtilExcel {
	...
	private static FileUtilExcel instance;
	
	public static synchronized FileUtilExcel getInstance() throws Exception {
		if(instance == null)
		{
			instance = new FileUtilExcel();
		}
		return instance;
	}
	
	private FileUtilExcel() throws Exception
	{
